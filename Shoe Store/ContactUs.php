    ...
    <div class="container">
        ...
        <div class="row">
            <div class="box">
                ...
                <div class="col-md-6">
                    <img class="img-responsive img-border-left" src="img/bshoe9.jpg" alt="">
                </div>
                <div class="col-md-6">
                    <p></p>
                    <b> Do you have anything to say? We look forward to listening!</b><br>
        <br>You can call from Sunday to Thursday<br> between 9:00 and 18:00
        <br> Friday 9:00 - 12:00
        <br> Service throughout the country
    </p>
    <p>
        <br>Harshada Ravte</br>
        <p>Mail us at: <b>harshadaravte1600@gmail.com</b></p>
        <br>95183910781<br>
        <br> 
    </p>
